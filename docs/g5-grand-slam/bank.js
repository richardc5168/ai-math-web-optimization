window.G5_GRAND_SLAM_BANK = [
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n列式：25×10,000。",
      "Hint 3｜計算引導\n👉 算式方向：先寫出「?? × 10,000」，再數位數、確認 0 的個數是否正確，最後標上單位「平方公尺」。"
    ],
    "steps": [
      "1 公頃 = 10,000 m²",
      "25×10,000 = 250,000",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n先算平行四邊形面積：12×6，再 ÷2。",
      "Hint 3｜計算引導\n👉 想法：用全等概念 → 拼出的大圖形面積 ÷ 幾塊 = 一塊的面積。先算大圖形面積，再均分。"
    ],
    "steps": [
      "平行四邊形面積 = 12×6 = 72",
      "一個三角形 = 72÷2 = 36",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 對對看：先算 3 個不同面的面積（長×寬、長×高、寬×高），加起來後再 ×2（因為每組有兩個一樣的面）。驗算：每個面的面積有沒有算錯。"
    ],
    "steps": [
      "lw=56，lh=48，wh=42",
      "相加 = 146",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 一步步算：① 先把時間變成總分鐘數 → ② 減掉要減的分鐘 → ③ 如果變成負數，就加上 1440（24 小時）→ ④ 換回 HH:MM。"
    ],
    "steps": [
      "05:00 → 300 分鐘",
      "減 70 得 230 分鐘",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n列式：2.5×100。",
      "Hint 3｜計算引導\n👉 算式方向：先寫出「?? × 100」，注意小數乘 100 時小數點往右移兩位，最後標上「公頃」。"
    ],
    "steps": [
      "1 km² = 100 公頃",
      "2.5×100 = 250",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n判斷小數位：12.5 有 1 位小數。",
      "Hint 3｜計算引導\n👉 計算小撇步：先把小數當整數算（忽略小數點），得到結果後再把小數點放回去（往左移回原來的小數位數）。最後用估算驗算：答案大約在多少範圍？"
    ],
    "steps": [
      "小數乘法：12.5×4",
      "計算得 50",
  ...
  },
  {
    ...
    "hints": [
      "Hint 1｜觀念\n百分率 = 部分 ÷ 全體，再乘 100%。",
      "Hint 2｜列式/判斷\n列式：12÷80×100。",
      "Hint 3｜計算引導\n👉 一步步算：① 部分 ÷ 全體 = 小數 → ② 小數 × 100 = 百分率。驗算：百分率 × 全體 ÷ 100 應該等於部分。"
    ],
    "steps": [
      "12÷80 = 15/100",
      "百分率 = 15%"
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 找最大值：把每個月的數字列出來，圈出最大的那個，它對應的月份就是答案。"
    ],
    "steps": [
      "找最大值 37",
      "出現在 4月",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 計算小撇步：兩數都當整數相乘，得到整數積後，把「兩個數的小數位數加起來」，在乘積從右邊數這麼多位放上小數點。最後估算一下有沒有合理。"
    ],
    "steps": [
      "估算 4.08×1.5 的範圍",
      "計算得 6.12",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n列式：剩下 = 750×(1 − 2/8)。",
      "Hint 3｜計算引導\n👉 一步步算：① 先算「1 − 已用掉的分數」得到剩下的分數 → ② 再用「總量 × 剩下的分數」算出剩下多少 → ③ 驗算：剩下＋用掉 = 總量？"
    ],
    "steps": [
      "1 − 2/8 = 3/4",
      "750×3/4 = 562",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n列式：5/8 × ( ? ) = 1，所以 ? = ？？。",
      "Hint 3｜計算引導\n👉 倒數就是分子分母互換。整數 n 的倒數是 1/n。把答案乘回原來的數，看是不是 = 1 就對了。"
    ],
    "steps": [
      "分子分母交換：5/8 → 8/5",
      "檢查：5/8×8/5 = 1"
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n做法：帶分數 → 假分數（整數×分母+分子）。",
      "Hint 3｜計算引導\n👉 一步步算：① 帶分數化成假分數（整數×分母＋分子）→ ② 通分 → ③ 分子相減 → ④ 化回帶分數或最簡分數。驗算：把答案加回減掉的數，看是否等於被減數。"
    ],
    "steps": [
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 一步步算：① 找公倍數 → ② 各分數同×到那個公倍數 → ③ 分子相加 → ④ 看能不能約分變最簡分數。做完再驗算：通分回去看原式是否相等。"
    ],
    "steps": [
      "lcm(10,8) = 40",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n列式：0.8×1000。",
      "Hint 3｜計算引導\n👉 算式方向：先寫「?? × 1000」，乘 1000 小數點右移三位，檢查位數後標上 mL。"
    ],
    "steps": [
      "1 L = 1000 mL",
      "0.8×1000 = 800 mL"
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 一步步算：① 先看哪個分子和哪個分母可以交叉約分 → ② 約完再分子×分子、分母×分母 → ③ 最後確認是最簡分數。"
    ],
    "steps": [
      "先交叉約分",
      "(1×5)/(12×9) 約分得 5/108",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 排水法超簡單：放進去後的水位 − 放進去前的水位 = 物體的體積。相減就好。"
    ],
    "steps": [
      "180 − 150 = 30",
      "1 mL = 1 cm³，體積 = 30 cm³"
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 一步步算：① 找到「要付多少 %」→ ② 原價 × 該百分比 ÷ 100 → ③ 驗算：折後價應 < 原價。"
    ],
    "steps": [
      "付款比例 = 80%",
      "600×80/100 = 480",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n把 +7 移到右邊：兩邊都減 7。",
      "Hint 3｜計算引導\n👉 移項口訣：「加的變減、減的變加」→ 把常數移到等號另一邊，x 就自己留下了。驗算：把答案代回去，左邊 = 右邊？"
    ],
    "steps": [
      "兩邊同減 7",
      "x = 24 − 7",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 拆解想：先算全部的表面積（兩個物體各自的），再減掉被蓋住看不到的面（×2，兩面都看不到）。驗算：答案 < 兩個寶物獨立的表面積加起來。"
    ],
    "steps": [
      "兩個正方體表面積 = 432",
      "扣除 2 個接觸面 = 72",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 一步步算：① 先把時間變成總分鐘數 → ② 加上要加的分鐘 → ③ 如果超過 1440（24 小時），就減掉 1440 → ④ 換回 HH:MM。"
    ],
    "steps": [
      "22:15 → 1335 分鐘",
      "加 180 得 1515 分鐘",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n列式：16×5÷2。",
      "Hint 3｜計算引導\n👉 套公式：底 × 高 ÷ 2。先乘再除，如果乘出來是奇數，結果會有小數。"
    ],
    "steps": [
      "三角形面積 = 底×高÷2",
      "16×5 = 80，÷2 = 40",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 口訣記住：「在中垂線上 → 到兩端等距」。這題只要想到這個性質就可以寫出答案了。"
    ],
    "steps": [
      "垂直平分線上的點到兩端距離相等",
      "PE = PC"
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n列式：0.2×10,000。",
      "Hint 3｜計算引導\n👉 換算訣竅：1% = 10,000 ppm。所以先把百分比數字 × 10,000 就好。驗算：答案是否看起來合理（比百分比的數字大很多）。"
    ],
    "steps": [
      "1% = 10,000 ppm",
      "0.2×10,000 = 2000 ppm"
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 找 GCD 方法：① 短除法或列因數法都可以 → ② 兩個數同時除以公因數，直到不能再除 → ③ 把除過的公因數全部乘起來。"
    ],
    "steps": [
      "最長且不剩 → 求 gcd(48,56)",
      "找 48 和 56 的共同因數",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 直接乘就好：每段 × 段數 = 總時間。如果超過 60 分鐘，記得換成「?? 小時 ?? 分」。"
    ],
    "steps": [
      "每段 15 分鐘 × 5 段",
      "15×5 = 75 分鐘"
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n列式：360×3/15。",
      "Hint 3｜計算引導\n👉 套公式：圓心角 = 佔整個圓的分數 × 360°。先把分數算出小數，再 × 360。驗算：答案 ≤ 360°。"
    ],
    "steps": [
      "整圓 360°，扇形占 3/15",
      "360×3÷15 = 72",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n列式：15×100。",
      "Hint 3｜計算引導\n👉 算式方向：先寫出「?? × 100」，乘 100 就是小數點右移兩位，記得標上「平方公尺」。"
    ],
    "steps": [
      "1 公畝 = 100 m²",
      "15×100 = 1,500 平方公尺"
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 時鐘口訣：分針位置 = 分鐘 × 6°；時針位置 = 小時 × 30° + 分鐘 × 0.5°。兩個角度的差就是夾角，如果差 > 180°，要用 360° 去減。"
    ],
    "steps": [
      "分針角度 = 30×6 = 180°",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 檢查方法：用 2、3、5、7… 一個一個試除。如果除到 √n 都沒有整除，就是質數。如果中間有一個整除了（而且不是 1 和自己），就是合數。"
    ],
    "steps": [
      "質數只有 1 和自己兩個因數",
  ...
  },
  {
    ...
    "hints": [
      "Hint 1｜觀念\n正方體有 6 個一樣的正方形面。",
      "Hint 2｜列式/判斷\n列式：表面積 = 6×a² = 6×3×3。",
      "Hint 3｜計算引導\n👉 正方體每一面都一樣！先算一面（邊長×邊長），再 ×6 就是答案。驗算數字有沒有算錯。"
    ],
    "steps": [
      "一個面 = 3×3 = 9",
      "6×9 = 54",
  ...
  },
  {
    ...
    "hints": [
      "Hint 1｜觀念\n梯形面積 = (上底+下底)×高÷2。",
      "Hint 2｜列式/判斷\n列式：(6+18)×6÷2。",
      "Hint 3｜計算引導\n👉 套公式：(上底 + 下底) × 高 ÷ 2。小提醒：先算括號裡面，再乘高，最後除以 2。"
    ],
    "steps": [
      "上底+下底 = 6+18 = 24",
      "24×6 = 144",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n看到 RF=RC，就想到『垂直平分線』。",
      "Hint 3｜計算引導\n👉 反過來也成立：「到兩端等距 → 在中垂線上」。記住：性質和逆敘述都是對的。"
    ],
    "steps": [
      "看到 RF=RC，距離相等",
      "聯想到垂直平分線",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 1 cm³ 就是 1 mL，數值完全一樣。只要把數字原封不動寫上去，改標 mL 就完成了！"
    ],
    "steps": [
      "1 cm³ = 1 mL",
      "1200 cm³ = 1200 mL"
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n兩邊都 ×3。",
      "Hint 3｜計算引導\n👉 要消掉除法，兩邊同乘那個除數。驗算：把答案代回去，左邊 = 右邊？"
    ],
    "steps": [
      "消掉 ÷3，兩邊同乘 3",
      "x = 17×3",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 一步步算：把整數寫成「?/1」→ 分子乘分子、分母乘分母 → 看能不能約分。最後心算驗一下：整數 × 分子 ÷ 分母 ≈ 多少？"
    ],
    "steps": [
      "整數寫成 9/1",
      "9×1 / (1×10) = 9/10",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 無條件捨去策略：① 找到目標位（例如千萬位）→ ② 把那個位以下的數字全歸零 → 驗算：答案是否只在目標位及以上有數字。"
    ],
    "steps": [
      "找到千萬位，位值 = 10,000,000",
  ...
  },
  {
    ...
    "hints": [
      "Hint 1｜觀念\n『幾分之幾的幾分之幾』→ 用乘法。",
      "Hint 2｜列式/判斷\n列式：128×1/4×1/4。",
      "Hint 3｜計算引導\n👉 一步步算：「⋯的幾分之幾的幾分之幾」= 連續乘。先算第一段，再乘第二段。驗算：答案應該比原來的數小很多。"
    ],
    "steps": [
      "『的』代表乘法",
      "128×1/4×1/4",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 拆開算：① 億前面的數字 × 1 億 → ② 萬前面的數字 × 1 萬 → ③ 剩下的直接加上。最後數數有沒有少了哪段。"
    ],
    "steps": [
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 找 LCM 方法：① 用短除法把兩數同時除到互質 → ② 把除數和剩下的數全部乘起來。或列倍數找最小的相同倍數。"
    ],
    "steps": [
      "再同時出現 → 求 lcm(5,4)",
      "列出 5 和 4 的倍數",
  ...
  },
  {
    ...
    "hints": [
      "Hint 1｜觀念\n等差規律：每次增加同樣的數。",
      "Hint 2｜列式/判斷\n先算公差：13 − 10 = 3。",
      "Hint 3｜計算引導\n👉 等差規律：先算公差（第二項 − 第一項），然後每一項都加上公差。用公差驗算後面的項是否也符合。"
    ],
    "steps": [
      "公差 = 13−10 = 3",
      "13+3 = 16"
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 找位數方法：從右邊開始數（個→十→百→千→萬→十萬→百萬…），數到目標位，看上面是什麼數字。"
    ],
    "steps": [
      "百萬位對應位值 1,000,000",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 一步步算：① 把「加幾成」換成「加 ??%」→ ② 新價 = 原價 × (100 + ??)% → ③ 驗算：新價應該比原價大。"
    ],
    "steps": [
      "加4成 = 加40%",
      "500×140/100 = 700",
  ...
  },
  {
    ...
    "hints": [
      "Hint 1｜觀念\n把 x 單獨留下：等式兩邊同除以係數。",
      "Hint 2｜列式/判斷\n兩邊都 ÷4。",
      "Hint 3｜計算引導\n👉 移項口訣：「乘的變除、除的變乘」→ 兩邊同除以係數。驗算：把答案代回去，左邊 = 右邊？"
    ],
    "steps": [
      "係數是 4",
      "兩邊同除以 4",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 3｜計算引導\n👉 看趨勢：比較指定時段開頭和結尾的數值，變大 → 上升，變小 → 下降，一樣 → 持平。"
    ],
    "steps": [
      "4月 = 28，5月 = 27",
      "27 < 28",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n想像『對折』：能對折成功的方向就是對稱軸。",
      "Hint 3｜計算引導\n👉 想像方法：在腦中或紙上「對折」，每一種能對折重合的方向就是一條對稱軸。正方形有 4 條，長方形有 2 條。"
    ],
    "steps": [
      "想像長方形（非正方形）對折方向",
      "能完全重合的直線有 2 條"
