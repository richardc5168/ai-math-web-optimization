"""Generate the offline bank for the 'Interactive G5 Life Pack 1 Empire' module.

Output:
  docs/interactive-g5-life-pack1-empire/bank.js
  dist_ai_math_web_pages/docs/interactive-g5-life-pack1-empire/bank.js
...
DOCS_OUT = ROOT / "docs" / "interactive-g5-life-pack1-empire" / "bank.js"
DIST_OUT = ROOT / "dist_ai_math_web_pages" / "docs" / "interactive-g5-life-pack1-empire" / "bank.js"
...
def write_bank_js(out_path: Path, bank: List[Dict]) -> None:
    ...
    js = (
        "// Auto-generated by scripts/generate_g5_life_pack1_empire_bank.py\n"
        "// 小五生活應用題（分數/小數/比例）第一包｜10 單元 × 20 題 = 200 題\n"
        "// window.G5_LIFE_PACK1_BANK = [...]\n\n"
        + "window.G5_LIFE_PACK1_BANK = "
